...
namespace Test.ShaSteel.WebAPI.Client
{
    ...
    public partial class Client : IRondsProxy
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<VibMetaDataOutput> VibMetaDataAsync(VibMetaDataInput input, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/VDiagnosis/VibMetaData");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<VibMetaDataOutput>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(VibMetaDataOutput);
                    }
                    finally
                    {
                        if (response_ != null)
