...
namespace Moons.ExportData2Center.Client
{
    ...
    public partial class Client
    {
        ...
        public System.Threading.Tasks.Task<ExportDataRequestOutput> ExportDataRequestAsync(ExportDataRequestInput input)
        {
            return PostAsync<ExportDataRequestInput, ExportDataRequestOutput>("/ExportDataRequest", input, System.Threading.CancellationToken.None);
        }

        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ImportDataRequestOutput> ImportDataRequestAsync(ImportDataRequestInput input)
        {
            return PostAsync<ImportDataRequestInput, ImportDataRequestOutput>($"/ImportDataRequest", input, System.Threading.CancellationToken.None);
        }
