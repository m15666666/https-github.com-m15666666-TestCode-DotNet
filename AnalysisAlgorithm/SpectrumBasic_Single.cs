...
namespace AnalysisAlgorithm
{
    ...
    public static partial class SpectrumBasic
    {
        ...
        //    // 起始于哪个象限
        //    int quadrant = MathBasic.Quadrant( reArray[0], imArray[0] );

        //    int phaseOffset = isClockWise ? MathConst.Deg_360 : -MathConst.Deg_360;
        ...
        //        Double reIm2Phase90 = MathBasic.ReIm2Phase90( re, im );

        //        // 4个象限角度的偏移
        //        int phaseOffset1 = MathConst.Deg_0;
        //        int phaseOffset2 = MathConst.Deg_0;
        //        int phaseOffset3 = MathConst.Deg_0;
        //        int phaseOffset4 = MathConst.Deg_0;

        //        // 90度的值
        //        int phase90 = MathConst.Deg_0;

        //        // 270度的值
        //        int phase270 = MathConst.Deg_0;

        //        if( isClockWise ) //起机顺时针
        //        {
        //            switch( quadrant )
        //            {
        //                case 1: //1432
        //                    {
        //                        phaseOffset1 = MathConst.Deg_0;
        //                        phaseOffset2 = -MathConst.Deg_180;
        //                        phaseOffset3 = -MathConst.Deg_180;
        //                        phaseOffset4 = MathConst.Deg_0;
        //                        phase270 = -MathConst.Deg_90;
        //                        phase90 = -MathConst.Deg_270;
        //                    }
        //                    break;
        ...
        //                        phaseOffset2 = MathConst.Deg_180;
        //                        phaseOffset3 = MathConst.Deg_180;
        //                        phaseOffset4 = MathConst.Deg_360;
        //                        phase270 = MathConst.Deg_270;
        //                        phase90 = MathConst.Deg_90;
        //                    }
        //                    break;
        //            }
        ...
        //        if( im >= 0 && re > 0 ) // 1
        //        {
        //            phase = reIm2Phase90 + phaseOffset1;
        //        }
        //        else if( im >= 0 && re < 0 ) // 2
        //        {
        //            phase = reIm2Phase90 + phaseOffset2;
        //        }
        //        else if( im < 0 && re < 0 ) // 3
        //        {
        //            phase = reIm2Phase90 + phaseOffset3;
        //        }
        //        else if( im < 0 && re > 0 ) // 4
        //        {
        //            phase = reIm2Phase90 + phaseOffset4;
        //        }
        //            // ReSharper disable CompareOfFloatsByEqualityOperator
        //        else if( im < 0 && re == 0 ) // -90°
        ...
        //        if( Math.Abs( BeForPhase - phase ) >= 350 )
        //        {
        //            phase += phaseOffset;
        //            BeForPhase = phase;
        //        }
        ...
        //    // 我们这里需要规定，相位的主体范围应当控制在-180° ~ 360°之间，于是计算相位的起点就应当保持在 -180° ~ 180°之间，所以只要加上判断：
        //    // if  phase（第一点）<= -180 （假定所有计算落在范围 - 360 ~360之间）then phase = phase + 360
        //    // 相位最小值在第一点（逆时针）或最后一点（顺时针）
        //    if ( Math.Min( ret[0], ret[ret.Length - 1] ) < -MathConst.Deg_180 )
        //    {
        //        CollectionUtils.OffsetArray( ret, MathConst.Deg_360 );
        //    }
