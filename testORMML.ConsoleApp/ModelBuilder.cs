...
using TestORMML.Model;

namespace TestORMML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\angular-projects\https-github.com-m15666666-TestCode-DotNet\TestML001\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\Administrator\AppData\Local\Temp\MLVSTools\testORMML\testORMML.Model\MLModel.zip";
