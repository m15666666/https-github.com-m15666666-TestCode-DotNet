...
///
/// </summary>
internal class ImplementQueueUsingStacksSolution
{
    ...
    {
        if (_s2.Count == 0)
            while (0 < _s1.Count) _s2.Push(_s1.Pop());
        return _s2.Pop();
    }

    public int Peek()
    {
        return 0 < _s2.Count ? _s2.Peek() : _front;
    }
